    ...
    const onSubmit = async (values: CalculosFormValues) => {
        ...
        try {
            ...
            const dbPayload: any = {
                ...
                quantidade_tabela: values.quantidadeTabela ?? resultados.quantidadeTabela,
                quantidade_baixo_peso: values.quantidadebaixopeso,
                peso_bruto_analise: values.pesoBrutoAnalise,
                tara_caixa: values.taraCaixa,
                peso_liquido_programado: values.pesoLiquidoProgramado ?? resultados.pesoLiquidoProgramado,
                peso_liquido_analise: values.pesoLiquidoAnalise ?? resultados.pesoLiquidoAnalise,
                peso_liquido_real: values.pesoLiquidoReal ?? resultados.pesoLiquidoReal,
                perda_kg: values.perdaKg ?? resultados.perdaKg,
                perda_cx: values.perdaCx ?? resultados.perdaCx,
                perda_percentual: values.perdaPercentual ?? resultados.perdaPercentual,
                peso_liquido_ideal_analise: values.pesoLiquidoIdealAnalise ?? resultados.pesoLiquidoIdealAnalise,
                peso_liquido_real_analise: values.pesoLiquidoRealAnalise ?? resultados.pesoLiquidoRealAnalise,
                media_baixo_peso_por_caixa: values.mediaPesoBaixoPorCaixa ?? resultados.mediaPesoBaixoPorCaixa,
                percentual_qtd_caixas_com_baixo_peso: values.percentualqtdcaixascombaixopeso ?? resultados.percentualqtdcaixascombaixopeso,
                media_qtd_caixas_com_baixo_peso: values.mediaqtdcaixascombaixopeso ?? resultados.mediaqtdcaixascombaixopeso,
                media_baixo_peso_por_cx: values.mediabaixopesoporcaixa ?? resultados.mediabaixopesoporcaixa,
